...
public class abd {
   ...
   public static Set<String> b() {
      ...
      a(hm.W, cer::g, $$0);
      a(hm.V, cjt::g, $$0);
      a(hm.ad, $$0x -> "stat." + $$0x.toString().replace(':', '.'), $$0);
      a($$0);
      return $$0;
   }
   ...
   public static void c() {
      a((Supplier<String>)(() -> "validate"));
      if (ab.aL) {
         b().forEach($$0 -> c.error("Missing translations: {}", $$0));
         ds.b();
         d();
      }
      ...
      iw.j.r().forEach($$0 -> {
         ...
         $$1.stream().flatMap(he::a).forEach($$0x -> {
            if (!((dkg)$$0x.a()).c().contains(dju.a())) {
               ad.a("Placed feature " + iw.e.c((dkg)$$0x.a()) + " is missing BiomeFilter.biome()");
            }
