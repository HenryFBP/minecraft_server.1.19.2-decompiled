...
public class afs {
   public static final Either<cxj, afs.a> a = Either.right(afs.a.b);
   public static final CompletableFuture<Either<cxj, afs.a>> b = CompletableFuture.completedFuture(a);
   public static final Either<cxt, afs.a> c = Either.right(afs.a.b);
   private static final Either<cxj, afs.a> d = Either.right(afs.a.b);
   private static final CompletableFuture<Either<cxt, afs.a>> e = CompletableFuture.completedFuture(c);
   private static final List<cxn> f = cxn.a();
   private static final afs.c[] g = afs.c.values();
   private static final int h = 64;
   private final AtomicReferenceArray<CompletableFuture<Either<cxj, afs.a>>> i = new AtomicReferenceArray(f.size());
   private final cgz j;
   private volatile CompletableFuture<Either<cxt, afs.a>> k = e;
   private volatile CompletableFuture<Either<cxt, afs.a>> l = e;
   private volatile CompletableFuture<Either<cxt, afs.a>> m = e;
   private CompletableFuture<cxj> n = CompletableFuture.completedFuture(null);
   @Nullable
   private final aln<afs.b> o = null;
   private int p;
   private int q;
   private int r;
   final cge s;
   ...
   public cxt d() {
      ...
      return $$1 == null ? null : (cxt)$$1.left().orElse(null);
   }
   ...
   public void a(chg $$0, int $$1) {
      Either<cxj, afs.a> $$2 = (Either)this.b(cxn.k).getNow(null);
      if ($$2 != null) {
         cxj $$3 = (cxj)$$2.left().orElse(null);
         if ($$3 != null) {
            $$3.a(true);
            cxt $$4 = this.d();
            if ($$4 != null) {
   ...
   public void a(cxt $$0) {
      if (this.t || !this.w.isEmpty() || !this.v.isEmpty()) {
         ...
         for(int $$3 = 0; $$3 < this.u.length; ++$$3) {
            $$2 += this.u[$$3] != null ? this.u[$$3].size() : 0;
         }
   ...
   private void a(tc<?> $$0, boolean $$1) {
      this.z.a(this.s, $$1).forEach($$1x -> $$1x.b.a($$0));
   }
   ...
   protected void a(String $$0, CompletableFuture<?> $$1) {
      ...
      this.n = this.n.thenCombine($$1, ($$0x, $$1x) -> $$0x);
   }
   ...
   private void a(CompletableFuture<? extends Either<? extends cxj, afs.a>> $$0, String $$1) {
      ...
      this.n = this.n.thenCombine($$0, ($$0x, $$1x) -> (cxj)$$1x.map($$0xx -> $$0xx, $$1xx -> $$0x));
   }
   ...
   public static afs.c c(int $$0) {
      return g[ami.a(33 - $$0 + 1, 0, g.length - 1)];
   }
