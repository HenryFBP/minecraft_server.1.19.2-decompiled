...
public class abj {
   ...
   private static final Gson c = new GsonBuilder()
      .registerTypeAdapter(ah.class, new ah.a())
      .registerTypeAdapter(abb.class, new abb.a())
      .setPrettyPrinting()
      .create();
   ...
   private void c() {
      ...
      for(Entry<af, ah> $$1 : this.h.entrySet()) {
         if (((ah)$$1.getValue()).a()) {
            $$0.add((af)$$1.getKey());
      ...
      if (this.g.isFile()) {
         try {
            ...
            try {
               ...
               for(Entry<abb, ah> $$5 : (List)$$4.collect(Collectors.toList())) {
   ...
   public void b() {
      ...
      try {
         OutputStream $$4 = new FileOutputStream(this.g);

         try {
            Writer $$5 = new OutputStreamWriter($$4, Charsets.UTF_8.newEncoder());
      ...
      if ($$3.a($$1)) {
         ...
         if (!$$4 && $$3.a()) {
            ...
            if ($$0.c() != null && $$0.c().i() && this.l.s.W().b(cgt.x)) {
               this.f.a(rq.a("chat.type.advancement." + $$0.c().e().a(), this.l.C_(), $$0.j()), false);
            }
         }
      }
   ...
   private void c(af $$0) {
      ah $$1 = this.b($$0);
      if (!$$1.a()) {
         for(Entry<String, ak> $$2 : $$0.f().entrySet()) {
   ...
   public void a(@Nullable af $$0) {
      ...
      if ($$1 != this.m) {
         this.l.b.a(new vt(this.m == null ? null : this.m.h()));
      }
