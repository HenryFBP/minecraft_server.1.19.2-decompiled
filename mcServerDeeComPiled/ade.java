...
public class ade {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> rq.a("commands.jfr.dump.failed", $$0));
   ...
   private static int b(dr $$0) throws CommandSyntaxException {
      try {
         ...
         rq $$3 = rq.b($$1.toString()).a(p.t).a($$1 -> $$1.a(new ro(ro.a.f, $$2.toString())).a(new rv(rv.a.a, rq.c("chat.copy.click"))));
