...
public class add {
   static final Dynamic3CommandExceptionType a = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> rq.a("commands.item.target.not_a_container", $$0, $$1, $$2)
   );
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> rq.a("commands.item.source.not_a_container", $$0, $$1, $$2)
   );
   static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> rq.a("commands.item.target.no_such_slot", $$0));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> rq.a("commands.item.source.no_such_slot", $$0));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> rq.a("commands.item.target.no_changes", $$0));
   private static final Dynamic2CommandExceptionType f = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> rq.a("commands.item.target.no_changed.known_item", $$0, $$1)
   );
                        ...
                        .then(
                           ds.a("block")
                              .then(
                                 ds.a("pos", fh.a())
                                    .then(
                                       ((RequiredArgumentBuilder)ds.a("slot", ev.a())
                                             .then(
                                                ds.a("with")
                                                   .then(
                                                      ((RequiredArgumentBuilder)ds.a("item", ft.a($$1))
                                                            .executes(
                                                               $$0x -> a(
                                                                     (dr)$$0x.getSource(),
                                                                     fh.a($$0x, "pos"),
                                                                     ev.a($$0x, "slot"),
                                                                     ft.a($$0x, "item").a(1, false)
                                                                  )
                                                            ))
                                                         .then(
                                                            ds.a("count", IntegerArgumentType.integer(1, 64))
                                                               .executes(
                                                                  $$0x -> a(
                                                                        ...
                                                                        fh.a($$0x, "pos"),
                                                                        ev.a($$0x, "slot"),
                                                                        ft.a($$0x, "item").a(IntegerArgumentType.getInteger($$0x, "count"), true)
                                                                     )
                                                               )
                                                         )
                                                   )
                                                   ...
                                                   .then(
                                                      ds.a("block")
                                                         .then(
                                                            ds.a("source", fh.a())
                                                               .then(
                                                                  ((RequiredArgumentBuilder)ds.a("sourceSlot", ev.a())
                                                                        .executes(
                                                                           $$0x -> a(
                                                                                 (dr)$$0x.getSource(),
                                                                                 fh.a($$0x, "source"),
                                 ...
                                 .then(
                                    ds.a("slot", ev.a())
                                       .then(
                                          ds.a("modifier", eq.a())
                                             .suggests(g)
                                             .executes($$0x -> a((dr)$$0x.getSource(), fh.a($$0x, "pos"), ev.a($$0x, "slot"), eq.d($$0x, "modifier")))
                                       )
                                 )
                           )
                     ))
                              ...
                              .then(
                                 ds.a("slot", ev.a())
                                    .then(
                                       ds.a("modifier", eq.a())
                                          .suggests(g)
                                          .executes($$0x -> a((dr)$$0x.getSource(), eb.b($$0x, "targets"), ev.a($$0x, "slot"), eq.d($$0x, "modifier")))
                                    )
                              )
                        )
                  )
   ...
   private static cax a(dr $$0, dto $$1, cax $$2) {
      agg $$3 = $$0.f();
      dsd.a $$4 = new dsd.a($$3).a(dul.f, $$0.e()).b(dul.a, $$0.g());
