      ...
      switch($$0.b()) {
         case d:
            ...
            if ($$0.c() != ab.b().getProtocolVersion()) {
               rq $$1;
               if ($$0.c() < 754) {
                  $$1 = rq.a("multiplayer.disconnect.outdated_client", ab.b().getName());
               } else {
                  $$1 = rq.a("multiplayer.disconnect.incompatible", ab.b().getName());
               }

               this.c.a(new zu($$1));
               this.c.a($$1);
            } else {
               this.c.a(new ahb(this.b, this.c));
            }
            break;
         case c:
            if (this.b.ai()) {
               this.c.a(qw.c);
               this.c.a(new ahd(this.b, this.c));
            } else {
               this.c.a(a);
            }
            break;
