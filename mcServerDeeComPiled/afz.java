...
public abstract class afz {
   ...
   static final int c = 33 + cxn.a(cxn.o) - 2;
   ...
   protected void a() {
      ++this.s;
      ObjectIterator<Entry<amt<agk<?>>>> $$0 = this.h.long2ObjectEntrySet().fastIterator();
      ...
      while($$0.hasNext()) {
         ...
         if ($$3) {
            this.i.b($$1.getLongKey(), a((amt<agk<?>>)$$1.getValue()), false);
         }
   ...
   private static int a(amt<agk<?>> $$0) {
      return !$$0.isEmpty() ? $$0.b().b() : aft.b + 1;
   }
   ...
   public boolean a(aft $$0) {
      ...
      if (!this.m.isEmpty()) {
         this.m.forEach($$1x -> $$1x.a($$0, this.r));
         this.m.clear();
         return true;
      } else {
         if (!this.q.isEmpty()) {
            ...
            while($$3.hasNext()) {
               long $$4 = $$3.nextLong();
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == agl.c)) {
                  afs $$5 = $$0.a($$4);
                  if ($$5 == null) {
                  ...
                  $$6.thenAccept($$1x -> this.r.execute(() -> this.p.a(afv.a(() -> {
                        }, $$4, false))));
               }
            }
   ...
   private amt<agk<?>> g(long $$0) {
      return (amt<agk<?>>)this.h.computeIfAbsent($$0, $$0x -> amt.a(4));
   }
   ...
   public void a(hq $$0, agh $$1) {
      cge $$2 = $$0.r();
      long $$3 = $$2.a();
      ((ObjectSet)this.g.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
      this.j.b($$3, 0, true);
      this.l.b($$3, 0, true);
   ...
   public void e() {
      ...
      ObjectIterator<Entry<amt<agk<?>>>> $$1 = this.h.long2ObjectEntrySet().fastIterator();
      ...
      while($$1.hasNext()) {
         ...
         if ($$4) {
            this.i.b($$2.getLongKey(), a((amt<agk<?>>)$$2.getValue()), false);
         }
   ...
   class c extends afz.b {
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            ...
            if ($$3) {
               afz.this.o.a(afv.a((Runnable)(() -> afz.this.r.execute(() -> {
                     if (this.c(this.c($$0))) {
                        afz.this.a($$0, $$4);
                        afz.this.q.add($$0);
                     } else {
               ...
               afz.this.p.a(afv.a(() -> afz.this.r.execute(() -> afz.this.b($$0, $$4)), $$0, true));
            }
         }
      ...
      public void a() {
         ...
         if (!this.g.isEmpty()) {
            ...
            while($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  afz.this.n.onLevelChange(new cge($$1), () -> this.f.get($$1), $$3, $$1x -> {
