...
public class apq extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(asr.m);
      Type<?> $$3 = this.getOutputSchema().getType(asr.m);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", $$2, $$3),
         this.fixTypeEverywhere("EntityIdFix", $$0, $$1, $$0x -> $$0xx -> $$0xx.mapFirst($$0xxx -> (String)a.getOrDefault($$0xxx, $$0xxx)))
      );
   }
}
