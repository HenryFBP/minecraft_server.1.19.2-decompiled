...
public class aej {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> rq.a("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> rq.a("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> rq.a("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );

   public static void a(CommandDispatcher<dr> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("spreadplayers").requires($$0x -> $$0x.c(2)))
            .then(
               ds.a("center", fn.a())
                  .then(
                     ds.a("spreadDistance", FloatArgumentType.floatArg(0.0F))
                        .then(
                           ((RequiredArgumentBuilder)ds.a("maxRange", FloatArgumentType.floatArg(1.0F))
                                 .then(
                                    ds.a("respectTeams", BoolArgumentType.bool())
                                       .then(
                                          ds.a("targets", eb.b())
                                             .executes(
                                                $$0x -> a(
                              ...
                              .then(
                                 ds.a("under")
                                    .then(
                                       ds.a("maxHeight", IntegerArgumentType.integer())
                                          .then(
                                             ds.a("respectTeams", BoolArgumentType.bool())
                                                .then(
                                                   ds.a("targets", eb.b())
   ...
   private static int a(dr $$0, dwp $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bbn> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         $$0.a(
            rq.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)), true
         );
         return $$14.length;
      }
   }
   ...
   private static double a(Collection<? extends bbn> $$0, agg $$1, aej.a[] $$2, int $$3, boolean $$4) {
      ...
      for(bbn $$8 : $$0) {
         ...
         $$8.m((double)ami.b($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)ami.b($$10.b) + 0.5);
