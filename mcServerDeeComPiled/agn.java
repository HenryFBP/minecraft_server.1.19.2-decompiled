...
public class agn implements chp {
   ...
   private final amn h;
   private final cyu i;
   private final dyf<cjt> j = new dyf<>($$0x -> this.B($$0x).o());
   private final dyf<dpu> k = new dyf<>($$0x -> this.B($$0x).p());
   private final chv l;
   private final cge m;
   private final cge n;
   private final cho o;
   ...
   public agn(agg $$0, List<cxj> $$1, cxn $$2, int $$3) {
      ...
      if ($$4 * $$4 != $$1.size()) {
         throw (IllegalStateException)ad.c(new IllegalStateException("Cache size is not a square."));
      } else {
         this.b = $$1;
   ...
   public cxj a(int $$0, int $$1, cxn $$2, boolean $$3) {
      ...
      if (!$$3) {
         ...
         if ($$6 != null) {
            throw (RuntimeException)ad.c(
               new RuntimeException(String.format(Locale.ROOT, "Chunk is not of correct status. Expecting %s, got %s | %s %s", $$2, $$6.j(), $$0, $$1))
            );
         } else {
            throw (RuntimeException)ad.c(new RuntimeException(String.format(Locale.ROOT, "We are asking a region for a chunk out of bound | %s %s", $$0, $$1)));
         }
      }
   }
   ...
   public boolean a(gt $$0, boolean $$1, @Nullable bbn $$2, int $$3) {
      ...
      if ($$4.h()) {
         ...
         if ($$1) {
            ...
            cjt.a($$4, (cgx)this.e, $$0, $$5, $$2, cax.b);
         }
