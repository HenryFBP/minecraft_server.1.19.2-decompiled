...
public class aeb {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> rq.a("commands.schedule.cleared.failure", $$0));
   private static final SuggestionProvider<dr> c = ($$0, $$1) -> dt.b(((dr)$$0.getSource()).m().aW().H().u().a(), $$1);
                  ...
                  ds.a("function")
                     .then(
                        ds.a("function", fs.a())
                           .suggests(acy.a)
                           .then(
                              ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ds.a("time", fa.a())
                                       .executes($$0x -> a((dr)$$0x.getSource(), fs.b($$0x, "function"), IntegerArgumentType.getInteger($$0x, "time"), true)))
                                    .then(
                                       ds.a("append")
                                          .executes(
                                             $$0x -> a((dr)$$0x.getSource(), fs.b($$0x, "function"), IntegerArgumentType.getInteger($$0x, "time"), false)
                                          )
                                    ))
                                 .then(
                                    ds.a("replace")
