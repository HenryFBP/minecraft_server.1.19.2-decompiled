...
public class arh extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<String> $$2 = DSL.fieldFinder("id", aua.a());
      OpticFinder<?> $$3 = $$0.findField("tag");
      OpticFinder<?> $$4 = $$3.type().findField("EntityTag");
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", $$0, $$4x -> {
         Optional<Pair<String, String>> $$5 = $$4x.getOptional($$1);
         if ($$5.isPresent() && Objects.equals(((Pair)$$5.get()).getSecond(), "minecraft:spawn_egg")) {
            Typed<?> $$6 = $$4x.getOrCreateTyped($$3);
            Typed<?> $$7 = $$6.getOrCreateTyped($$4);
            Optional<String> $$8 = $$7.getOptional($$2);
            if ($$8.isPresent()) {
               return $$4x.set($$1, Pair.of(asr.s.typeName(), (String)a.getOrDefault($$8.get(), "minecraft:pig_spawn_egg")));
            }
         }
