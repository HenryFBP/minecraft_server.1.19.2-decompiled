...
public class adt {
   public static void a(CommandDispatcher<dr> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a(
                     ...
                     .then(ds.a("sound").then(ds.a("type", dx.a()).executes($$0x -> a((dr)$$0x.getSource(), dx.a($$0x, "type"))))))
   ...
   private static int a(dr $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2 != null) {
         int $$3 = $$2.l();
         if ($$1 > $$3) {
            $$0.b(rq.b("Sorry, the max bad omen level you can set is " + $$3));
         } else {
            int $$4 = $$2.m();
            $$2.a($$1);
   ...
   private static int b(dr $$0) {
      ...
      bvk $$1 = bbr.at.a((cgx)$$0.f());
      $$1.v(true);
      $$1.a(bbs.f, bvj.s());
      $$1.e($$0.e().c, $$0.e().d, $$0.e().e);
      $$1.a($$0.f(), $$0.f().d_(new gt($$0.e())), bcg.n, null, null);
      $$0.f().a_($$1);
      return 1;
   }
   ...
   private static int a(dr $$0, rq $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         $$0.f().a(null, new gt($$0.e().b(5.0, 0.0, 0.0)), ajw.qI, ajx.g, 2.0F, 1.0F);
      }
   ...
   private static int b(dr $$0, int $$1) throws CommandSyntaxException {
      ...
      gt $$3 = $$2.da();
      if ($$2.x().d($$3)) {
         $$0.b(rq.b("Raid already started close by"));
         return -1;
      } else {
         bvl $$4 = $$2.x().y();
         bvj $$5 = $$4.a($$2);
         if ($$5 != null) {
            ...
            $$0.b(rq.b("Failed to create a raid in your local village"));
         }
   ...
   private static int d(dr $$0) throws CommandSyntaxException {
      ...
      if ($$1 != null) {
         ...
         $$0.b(rq.b("Found no started raids"));
         return 0;
      }
   }
