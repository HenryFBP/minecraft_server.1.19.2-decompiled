...
public class apg extends DataFix {
   ...
   public apg(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public static int a(String $$0) {
      Integer $$1 = (Integer)a.get($$0);
      return $$1 == null ? 0 : $$1;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> $$4 = DSL.and(
         DSL.optional(DSL.field("inTile", DSL.named(asr.r.typeName(), DSL.or(DSL.intType(), aua.a())))), DSL.remainderType()
      );
      Function<Typed<?>, Typed<?>> $$5 = $$1x -> $$1x.update($$4.finder(), DSL.remainderType(), Pair::getSecond);
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", $$0.getType(asr.q), $$1.getType(asr.q), $$3x -> {
   ...
   private Typed<?> a(Typed<?> $$0) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> $$1 = DSL.optional(
         DSL.field("Block", DSL.named(asr.r.typeName(), DSL.or(DSL.intType(), aua.a())))
      );
      Type<Either<Pair<String, Dynamic<?>>, Unit>> $$2 = DSL.optional(DSL.field("BlockState", DSL.named(asr.n.typeName(), DSL.remainderType())));
      Dynamic<?> $$3 = (Dynamic)$$0.get(DSL.remainderFinder());
      return $$0.update($$1.finder(), $$2, $$1x -> {
         int $$2x = $$1x.map($$0xx -> (Integer)((Either)$$0xx.getSecond()).map($$0xxx -> $$0xxx, apg::a), $$1xx -> {
            Optional<Number> $$2xx = $$3.get("TileID").asNumber().result();
            return (Integer)$$2xx.map(Number::intValue).orElseGet(() -> $$3.get("Tile").asByte((byte)0) & 0xFF);
         });
         int $$3x = $$3.get("Data").asInt(0) & 15;
         return Either.left(Pair.of(asr.n.typeName(), aol.b($$2x << 4 | $$3x)));
      }).set(DSL.remainderFinder(), $$3.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> a(Typed<?> $$0, String $$1, String $$2, String $$3) {
      Type<Pair<String, Either<Integer, String>>> $$4 = DSL.field($$1, DSL.named(asr.r.typeName(), DSL.or(DSL.intType(), aua.a())));
      Type<Pair<String, Dynamic<?>>> $$5 = DSL.field($$3, DSL.named(asr.n.typeName(), DSL.remainderType()));
      Dynamic<?> $$6 = (Dynamic)$$0.getOrCreate(DSL.remainderFinder());
      return $$0.update($$4.finder(), $$5, $$2x -> {
         int $$3x = ((Either)$$2x.getSecond()).map($$0xx -> $$0xx, apg::a);
         int $$4x = $$6.get($$2).asInt(0) & 15;
         return Pair.of(asr.n.typeName(), aol.b($$3x << 4 | $$4x));
