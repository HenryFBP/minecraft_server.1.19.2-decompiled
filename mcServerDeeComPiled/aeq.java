...
public class aeq {
   ...
   public static void a(CommandDispatcher<dr> $$0) {
      LiteralCommandNode<dr> $$1 = $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("teleport").requires($$0x -> $$0x.c(2)))
                  .then(
                     ds.a("location", fo.a())
                        .executes(
                           $$0x -> a(
                                 (dr)$$0x.getSource(),
                                 Collections.singleton(((dr)$$0x.getSource()).h()),
                                 ((dr)$$0x.getSource()).f(),
                                 fo.b($$0x, "location"),
                                 fq.d(),
                                 null
               ...
               .then(
                  ds.a("destination", eb.a())
                     .executes($$0x -> a((dr)$$0x.getSource(), Collections.singleton(((dr)$$0x.getSource()).h()), eb.a($$0x, "destination")))
               ))
            .then(
               ((RequiredArgumentBuilder)ds.a("targets", eb.b())
                     .then(
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ds.a("location", fo.a())
                                 .executes(
                                    $$0x -> a((dr)$$0x.getSource(), eb.b($$0x, "targets"), ((dr)$$0x.getSource()).f(), fo.b($$0x, "location"), null, null)
                                 ))
                              .then(
                                 ds.a("rotation", fl.a())
                                    .executes(
                           ...
                           .then(
                              ((LiteralArgumentBuilder)ds.a("facing")
                                    .then(
                                       ds.a("entity")
                                          .then(
                                             ((RequiredArgumentBuilder)ds.a("facingEntity", eb.a())
                                                   .executes(
                                                      $$0x -> a(
                                                            (dr)$$0x.getSource(),
                                                            eb.b($$0x, "targets"),
                                                            ...
                                                            fo.b($$0x, "location"),
                                                            null,
                                                            new aeq.a(eb.a($$0x, "facingEntity"), ea.a.a)
                                                         )
                                                   ))
                                                .then(
                                                   ds.a("facingAnchor", ea.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               (dr)$$0x.getSource(),
                                                               eb.b($$0x, "targets"),
                                                               ...
                                                               fo.b($$0x, "location"),
                                                               null,
                                                               new aeq.a(eb.a($$0x, "facingEntity"), ea.a($$0x, "facingAnchor"))
                                                            )
                                                      )
                                                )
                                          )
                                    ...
                                    ds.a("facingLocation", fo.a())
                                       .executes(
                                          $$0x -> a(
                                                ...
                                                fo.b($$0x, "location"),
                                                null,
                                                new aeq.a(fo.a($$0x, "facingLocation"))
                                             )
                                       )
                                 )
                           )
                     ))
                  .then(ds.a("destination", eb.a()).executes($$0x -> a((dr)$$0x.getSource(), eb.b($$0x, "targets"), eb.a($$0x, "destination"))))
            )
      );
   ...
   private static int a(dr $$0, Collection<? extends bbn> $$1, bbn $$2) throws CommandSyntaxException {
      for(bbn $$3 : $$1) {
         a($$0, $$3, (agg)$$2.s, $$2.df(), $$2.dh(), $$2.dl(), EnumSet.noneOf(vl.a.class), $$2.dq(), $$2.ds(), null);
      }
