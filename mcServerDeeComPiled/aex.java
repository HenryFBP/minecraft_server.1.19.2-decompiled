   ...
   public static void a(CommandDispatcher<dr> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a(
                  ...
                  .then(ds.a("add").then(ds.a("targets", ed.a()).suggests(($$0x, $$1) -> {
                     aiz $$2 = ((dr)$$0x.getSource()).m().ac();
                     return dt.b($$2.t().stream().filter($$1x -> !$$2.i().a($$1x.fy())).map($$0xx -> $$0xx.fy().getName()), $$1);
                  }).executes($$0x -> a((dr)$$0x.getSource(), ed.a($$0x, "targets"))))))
               .then(
                  ds.a("remove")
                     .then(
                        ds.a("targets", ed.a())
                           .suggests(($$0x, $$1) -> dt.a(((dr)$$0x.getSource()).m().ac().j(), $$1))
                           .executes($$0x -> b((dr)$$0x.getSource(), ed.a($$0x, "targets")))
                     )
               ))
