...
public class acx {
   ...
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> rq.a("commands.forceload.toobig", $$0, $$1));
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> rq.a("commands.forceload.query.failure", $$0, $$1));
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("forceload").requires($$0x -> $$0x.c(2)))
                  .then(
                     ds.a("add")
                        .then(
                           ((RequiredArgumentBuilder)ds.a("from", fi.a())
                                 .executes($$0x -> a((dr)$$0x.getSource(), fi.a($$0x, "from"), fi.a($$0x, "from"), true)))
                              .then(ds.a("to", fi.a()).executes($$0x -> a((dr)$$0x.getSource(), fi.a($$0x, "from"), fi.a($$0x, "to"), true)))
                        )
                  ))
               .then(
                  ((LiteralArgumentBuilder)ds.a("remove")
                        .then(
                           ((RequiredArgumentBuilder)ds.a("from", fi.a())
                                 .executes($$0x -> a((dr)$$0x.getSource(), fi.a($$0x, "from"), fi.a($$0x, "from"), false)))
                              .then(ds.a("to", fi.a()).executes($$0x -> a((dr)$$0x.getSource(), fi.a($$0x, "from"), fi.a($$0x, "to"), false)))
                        ))
                     .then(ds.a("all").executes($$0x -> b((dr)$$0x.getSource())))
               ))
            .then(
               ((LiteralArgumentBuilder)ds.a("query").executes($$0x -> a((dr)$$0x.getSource())))
                  .then(ds.a("pos", fi.a()).executes($$0x -> a((dr)$$0x.getSource(), fi.a($$0x, "pos"))))
            )
      );
   }
   ...
   private static int a(dr $$0) {
      ...
      if ($$4 > 0) {
         ...
         $$0.b(rq.a("commands.forceload.added.none", $$2.a()));
      }
   ...
   private static int b(dr $$0) {
      ...
      aba<cgx> $$2 = $$1.ab();
      LongSet $$3 = $$1.v();
      $$3.forEach($$1x -> $$1.a(cge.a($$1x), cge.b($$1x), false));
