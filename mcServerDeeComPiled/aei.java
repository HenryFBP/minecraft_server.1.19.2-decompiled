...
public class aei {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> rq.a("commands.spectate.not_spectator", $$0));

   public static void a(CommandDispatcher<dr> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("spectate").requires($$0x -> $$0x.c(2)))
               .executes($$0x -> a((dr)$$0x.getSource(), null, ((dr)$$0x.getSource()).i())))
            .then(
               ((RequiredArgumentBuilder)ds.a("target", eb.a()).executes($$0x -> a((dr)$$0x.getSource(), eb.a($$0x, "target"), ((dr)$$0x.getSource()).i())))
                  .then(ds.a("player", eb.c()).executes($$0x -> a((dr)$$0x.getSource(), eb.a($$0x, "target"), eb.e($$0x, "player"))))
            )
      );
   }
