...
public class agz implements ahc, re, xm {
   ...
   public static final double a = ami.m(6.0);
   ...
   private final AtomicReference<Instant> N = new AtomicReference(Instant.EPOCH);
   private final sg.a O;
   private final ry P = new ry();
   private final alx Q;
   ...
   public void c() {
      ...
      if (this.F && !this.c.fj() && !this.c.bI()) {
         if (++this.G > 80) {
            ...
            this.b(rq.c("multiplayer.disconnect.flying"));
            return;
         }
      } else {
         this.F = false;
      ...
      if ($$0 - this.k >= 15000L) {
         if (this.l) {
            this.b(rq.c("disconnect.timeout"));
         } else {
            this.l = true;
            this.k = $$0;
            this.m = $$0;
      ...
      if (this.c.I() > 0L && this.h.al() > 0 && ad.b() - this.c.I() > (long)(this.h.al() * 1000 * 60)) {
         this.b(rq.c("multiplayer.disconnect.idling"));
      }
   ...
   public void b(rq $$0) {
      this.b.a(new uf($$0), rb.a((Runnable)(() -> this.b.a($$0))));
      this.b.l();
      this.h.h(this.b::m);
   }
   ...
   private static double a(double $$0) {
      return ami.a($$0, -3.0E7, 3.0E7);
   }

   private static double b(double $$0) {
      return ami.a($$0, -2.0E7, 2.0E7);
   }
   ...
   public void a(yj $$0) {
      ...
      if (c($$0.b(), $$0.c(), $$0.d(), $$0.e(), $$0.f())) {
         this.b(rq.c("multiplayer.disconnect.invalid_vehicle_movement"));
      } else {
         bbn $$1 = this.c.cO();
         if ($$1 != this.c && $$1.cG() == this.c && $$1 == this.v) {
            ...
            boolean $$16 = $$2.a($$1, $$1.cy().h(0.0625));
            $$11 = $$6 - this.z;
            $$12 = $$7 - this.A - 1.0E-6;
            $$13 = $$8 - this.B;
            boolean $$17 = $$1.B;
            ...
            $$1.a($$6, $$7, $$8, $$9, $$10);
            boolean $$20 = $$2.a($$1, $$1.cy().h(0.0625));
            if ($$16 && ($$19 || !$$20)) {
               $$1.a($$3, $$4, $$5, $$9, $$10);
               this.b.a(new ux($$1));
               return;
            ...
            this.H = $$12 >= -0.03125 && !$$17 && !this.h.Y() && !$$1.aN() && this.a($$1);
            this.z = $$1.df();
            this.A = $$1.dh();
            this.B = $$1.dl();
         }
   ...
   private boolean a(bbn $$0) {
      return $$0.s.a($$0.cy().g(0.0625).b(0.0, -0.55, 0.0)).allMatch(cvn.a::h);
   }
   ...
   public void a(xo $$0) {
      ...
      if ($$0.b() == this.D) {
         if (this.C == null) {
            this.b(rq.c("multiplayer.disconnect.invalid_player_movement"));
            return;
         }
   ...
   public void a(yt $$0) {
      te.a($$0, this, this.c.x());
      this.h.aE().a($$0.b()).ifPresent(this.c.E()::e);
   }
   ...
   public void a(xx $$0) {
      ...
      this.h.aC().a().getCompletionSuggestions($$2).thenAccept($$1x -> this.b.a(new tu($$0.b(), $$1x)));
   }
   ...
   public void a(za $$0) {
      te.a($$0, this, this.c.x());
      if (!this.h.n()) {
         this.c.a(rq.c("advMode.notEnabled"));
      } else if (!this.c.fY()) {
         this.c.a(rq.c("advMode.notAllowed"));
      } else {
         cfy $$1 = null;
         ctp $$2 = null;
         gt $$3 = $$0.b();
         ...
         if ($$1 != null) {
            ...
            cvo $$13 = (switch($$0.g()) {
               ...
               case b -> cju.js.m();
               default -> cju.eU.m();
            }).a(ckv.a, $$9).a(ckv.b, Boolean.valueOf($$0.e()));
            if ($$13 != $$8) {
               this.c.s.a($$3, $$13, 2);
               $$4.b($$13);
               this.c.s.l($$3).a($$4);
            ...
            $$1.f();
            if (!amx.b($$5)) {
               this.c.a(rq.a("advMode.setCommand.success", $$5));
            }
         }
   ...
   public void a(zb $$0) {
      ...
      if (!this.h.n()) {
         ...
         if ($$1 != null) {
            ...
            $$1.f();
            this.c.a(rq.a("advMode.setCommand.success", $$0.b()));
         }
   ...
   public void a(yl $$0) {
      te.a($$0, this, this.c.x());
      this.c.fA().c($$0.b());
      this.c.b.a(new tz(-2, 0, this.c.fA().k, this.c.fA().a(this.c.fA().k)));
      this.c.b.a(new tz(-2, 0, $$0.b(), this.c.fA().a($$0.b())));
      this.c.b.a(new wc(this.c.fA().k));
   }
      ...
      if (this.c.fY()) {
         ...
         if ($$3 instanceof cuo $$4) {
            ...
            if ($$4.g()) {
               ...
               if ($$0.c() == cuo.a.b) {
                  if ($$4.D()) {
                     this.c.a(rq.a("structure_block.save_success", $$5), false);
                  } else {
                     this.c.a(rq.a("structure_block.save_failure", $$5), false);
                  }
               } else if ($$0.c() == cuo.a.c) {
                  if (!$$4.F()) {
                     this.c.a(rq.a("structure_block.load_not_found", $$5), false);
                  } else if ($$4.a(this.c.x())) {
                     this.c.a(rq.a("structure_block.load_success", $$5), false);
                  } else {
                     this.c.a(rq.a("structure_block.load_prepare", $$5), false);
                  }
               } else if ($$0.c() == cuo.a.d) {
                  if ($$4.C()) {
                     this.c.a(rq.a("structure_block.size_success", $$5), false);
                  } else {
                     this.c.a(rq.c("structure_block.size_failure"), false);
                  }
               }
            } else {
               this.c.a(rq.a("structure_block.invalid_structure_name", $$0.e()), false);
            }
   ...
   public void a(yc $$0) {
      ...
      if (bub.d($$1) || $$1 == 40) {
         ...
         Consumer<List<agv>> $$4 = $$3.isPresent() ? $$1x -> this.a((agv)$$1x.get(0), $$1x.subList(1, $$1x.size()), $$1) : $$1x -> this.a($$1x, $$1);
         this.a($$2).thenAcceptAsync($$4, this.h);
      }
   }
   ...
   private void a(agv $$0, List<agv> $$1, int $$2) {
      ...
      if ($$3.a(caz.rX)) {
         ...
         $$4.a("author", qa.a(this.c.X().getString()));
         if (this.c.U()) {
            $$4.a("title", qa.a($$0.b()));
         } else {
            $$4.a("filtered_title", qa.a($$0.b()));
            $$4.a("title", qa.a($$0.d()));
         }

         this.a($$1, $$0x -> rq.a.a(rq.b($$0x)), $$4);
         this.c.fA().a($$2, $$4);
      }
   }
   ...
   private void a(List<agv> $$0, UnaryOperator<String> $$1, cax $$2) {
      pp $$3 = new pp();
      if (this.c.U()) {
         $$0.stream().map($$1x -> qa.a((String)$$1.apply($$1x.b()))).forEach($$3::add);
      } else {
         pj $$4 = new pj();
         int $$5 = 0;
   ...
   public void a(yi $$0) {
      te.a($$0, this, this.c.x());
      if (c($$0.a(0.0), $$0.b(0.0), $$0.c(0.0), $$0.a(0.0F), $$0.b(0.0F))) {
         this.b(rq.c("multiplayer.disconnect.invalid_player_movement"));
      } else {
         agg $$1 = this.c.x();
         if (!this.c.f) {
            ...
            if (this.C != null) {
               ...
               if (this.c.bI()) {
                  ...
                  if (this.c.fj()) {
                     ...
                     boolean $$20 = this.c.B;
                     this.c.a(bci.b, new dwq($$11, $$12, $$13));
                     $$11 = $$2 - this.c.df();
                     $$12 = $$3 - this.c.dh();
                     if ($$12 > -0.5 || $$12 < 0.5) {
                        $$12 = 0.0;
                     ...
                     $$15 = $$11 * $$11 + $$12 * $$12 + $$13 * $$13;
                     boolean $$22 = false;
                     if (!this.c.K() && $$15 > 0.0625 && !this.c.fj() && !this.c.d.e() && this.c.d.b() != cgu.d) {
                        $$22 = true;
                        d.warn("{} moved wrongly!", this.c.X().getString());
                     }

                     this.c.a($$2, $$3, $$4, $$5, $$6);
                     if (this.c.Q || this.c.fj() || (!$$22 || !$$1.a(this.c, $$18)) && !this.a($$1, $$18)) {
                        this.F = $$12 >= -0.03125
                           && !$$20
                           && this.c.d.b() != cgu.d
                           && !this.h.Y()
   ...
   private boolean a(cha $$0, dwl $$1) {
      Iterable<dxj> $$2 = $$0.c(this.c, this.c.cy().h(1.0E-5F));
      dxj $$3 = dxg.a($$1.h(1.0E-5F));
   ...
   public void a(double $$0, double $$1, double $$2, float $$3, float $$4, Set<vl.a> $$5, boolean $$6) {
      double $$7 = $$5.contains(vl.a.a) ? this.c.df() : 0.0;
      double $$8 = $$5.contains(vl.a.b) ? this.c.dh() : 0.0;
      double $$9 = $$5.contains(vl.a.c) ? this.c.dl() : 0.0;
      ...
      this.E = this.i;
      this.c.a($$0, $$1, $$2, $$3, $$4);
      this.c.b.a(new vl($$0 - $$7, $$1 - $$8, $$2 - $$9, $$3 - $$10, $$4 - $$11, $$5, this.D, $$6));
   }
   ...
   public void a(yo $$0) {
      ...
      switch($$2) {
         case g:
            if (!this.c.B_()) {
               cax $$3 = this.c.b(bai.b);
               this.c.a(bai.b, this.c.b(bai.a));
               this.c.a(bai.a, $$3);
               this.c.eZ();
            }
   ...
   public void a(zi $$0) {
      ...
      if (!(this.c.bj().g($$7) > a)) {
         ...
         if (Math.abs($$8.a()) < 1.0000001 && Math.abs($$8.b()) < 1.0000001 && Math.abs($$8.c()) < 1.0000001) {
            ...
            int $$11 = this.c.s.ah();
            if ($$6.v() < $$11) {
               if (this.C == null && this.c.h((double)$$6.u() + 0.5, (double)$$6.v() + 0.5, (double)$$6.w() + 0.5) < 64.0 && $$1.a(this.c, $$6)) {
            ...
            this.c.b.a(new tp($$1, $$6));
            this.c.b.a(new tp($$1, $$6.a($$10)));
         } else {
   ...
   public void a(yv $$0) {
      ...
      if ($$0.b() == yv.a.b && this.h.S()) {
         ...
         this.b(rq.c("multiplayer.requiredTexturePrompt.disconnect"));
      }
   ...
   public void a(rq $$0) {
      ...
      this.h.ar();
      this.h.ac().a(rq.a("multiplayer.player.left", this.c.C_()).a(p.o), false);
      this.c.s();
      this.h.ac().c(this.c);
      this.c.T().b();
      if (this.g()) {
   ...
   public void a(tc<?> $$0, @Nullable rb $$1) {
      try {
         ...
         $$4.a("Packet class", (s<String>)(() -> $$0.getClass().getCanonicalName()));
         throw new z($$3);
      }
   }
   ...
   public void a(xt $$0) {
      if (c($$0.b())) {
         this.b(rq.c("multiplayer.disconnect.illegal_characters"));
      } else {
   ...
   private void b(xs $$0) {
      ...
      dp $$4 = new dp.a($$2);
      $$1 = ds.a($$1, (UnaryOperator<dr>)($$1x -> $$1x.a($$4)));
      this.h.aC().a($$1, $$0.b());
   }
   ...
   private Map<String, sd> a(xs $$0, se<?> $$1) {
      ...
      for(Pair<String, String> $$7 : dv.b($$1)) {
   ...
   private boolean a(String $$0, Instant $$1, rw.b $$2) {
      if (!this.a($$1)) {
         ...
         this.b(rq.c("multiplayer.disconnect.out_of_order_chat"));
         return false;
      } else if (this.c.A() == bua.c) {
         this.a(new xa(rq.c("chat.disabled.options").a(p.m), false));
         return false;
      } else {
         Set<ry.a> $$3;
         synchronized(this.P) {
   ...
   private void b(sd $$0) {
      this.h.ac().a($$0, this.c, rm.a(rm.c, this.c));
      this.h();
   }
   ...
   private boolean c(sd $$0) {
      ...
      if ($$2 != null) {
         if ($$2.b().a()) {
            this.c.a(rq.c("chat.disabled.expiredProfileKey").a(p.m));
            return false;
         }

         if (!$$0.a($$1)) {
            this.b(rq.c("multiplayer.disconnect.unsigned_chat"));
            return false;
         }
      }
   ...
   public void a(xu $$0) {
      if (this.i()) {
         this.M.a(() -> {
            int $$1 = $$0.b();
            String $$2 = $$0.c();
            return this.d($$2).thenAccept($$1x -> this.a($$1, $$1x));
         });
      }
   ...
   private void a(int $$0, rq $$1) {
      this.a(new ts($$0, $$1), rb.a((Supplier<tc<?>>)(() -> new ts($$0, null))));
   }
   ...
   private CompletableFuture<rq> e(String $$0) {
      rq $$1 = rq.b($$0);
      CompletableFuture<rq> $$2 = this.h.bf().decorate(this.c, $$1).thenApply($$1x -> !$$1.equals($$1x) ? $$1x : null);
      $$2.thenAcceptAsync($$1x -> this.L.a($$0, $$1x), this.h);
      return $$2;
   }
   ...
   private CompletableFuture<rq> f(String $$0) {
      ...
      $$3.thenAcceptAsync($$1x -> this.L.a($$0, $$1x), this.h);
      return $$3;
   }
   ...
   private void a(Set<ry.a> $$0) {
      ...
      this.b(rq.c("multiplayer.disconnect.chat_validation_failed"));
   }
   ...
   public void a(yp $$0) {
      ...
      switch($$0.c()) {
         ...
         case f:
            ...
            break;
         case g:
            if (this.c.cQ() instanceof bcn $$3) {
               $$3.b();
            }
            break;
         case h:
            bbn $$2 = this.c.cQ();
            if ($$2 instanceof bbw $$4) {
               $$4.b(this.c);
            }
            break;
         case i:
   ...
   public void a(sd $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 > 4096) {
            this.b(rq.c("multiplayer.disconnect.too_many_pending_chats"));
         }
         ...
         if ($$2.e(this.c.bj()) < a) {
            $$0.a(new ye.c() {
               private void a(bai $$0, agz.a $$1) {
                  cax $$2 = agz.this.c.b($$0).o();
                  baj $$3 = $$1.run(agz.this.c, $$2, $$0);
                  if ($$3.a()) {
                     aj.Q.a(agz.this.c, $$2, $$2);
                     if ($$3.b()) {
                        agz.this.c.a($$0, true);
                     }
                  }
               ...
               public void a(bai $$0, dwq $$1) {
                  this.a($$0, ($$1x, $$2xx, $$3) -> $$2xx.a($$1x, $$1, $$3));
               }
               ...
               public void a() {
                  if (!($$2 instanceof bqv) && !($$2 instanceof bbt) && !($$2 instanceof bui) && $$2 != agz.this.c) {
                     ...
                     agz.this.b(rq.c("multiplayer.disconnect.invalid_entity_attacked"));
      ...
      switch($$1) {
         case a:
            if (this.c.f) {
               ...
               if (this.h.g()) {
                  this.c.a(cgu.d);
                  this.c.x().W().a(cgt.q).a(false, this.h);
               }
            }
            break;
         case b:
   ...
   public void a(ym $$0) {
      ...
      if (!this.c.B_() && this.c.bU.j == $$0.b() && this.c.bU instanceof bxv) {
         if (!this.c.bU.a(this.c)) {
            ...
            this.h.aE().a($$0.c()).ifPresent($$1 -> ((bxv)this.c.bU).a($$0.d(), $$1, this.c));
         }
      }
   }
   ...
   public void a(xy $$0) {
      ...
      if (this.c.bU.j == $$0.b() && !this.c.B_()) {
         if (!this.c.bU.a(this.c)) {
            ...
            boolean $$1 = this.c.bU.b(this.c, $$0.c());
            if ($$1) {
               this.c.bU.d();
            }
   ...
   public void a(zf $$0) {
      ...
      this.a($$1).thenAcceptAsync($$1x -> this.a($$0, $$1x), this.h);
   }
