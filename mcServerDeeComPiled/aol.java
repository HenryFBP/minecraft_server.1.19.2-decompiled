...
public class aol {
   ...
   private static final Dynamic<?>[] c = new Dynamic[4096];
   private static final Dynamic<?>[] d = new Dynamic[256];
   private static final Object2IntMap<Dynamic<?>> e = (Object2IntMap<Dynamic<?>>)DataFixUtils.make(
      new Object2IntOpenHashMap(), $$0 -> $$0.defaultReturnValue(-1)
   );
   private static final Object2IntMap<String> f = (Object2IntMap<String>)DataFixUtils.make(new Object2IntOpenHashMap(), $$0 -> $$0.defaultReturnValue(-1));
   static final String a = "%%FILTER_ME%%";

   private static void a(int $$0, String $$1, String... $$2) {
      Dynamic<?> $$3 = b($$1);
      c[$$0] = $$3;
      int $$4 = $$0 >> 4;
      if (d[$$4] == null) {
   ...
   public static Dynamic<?> b(String $$0) {
      try {
         return new Dynamic(pu.a, qd.a($$0.replace('\'', '"')));
