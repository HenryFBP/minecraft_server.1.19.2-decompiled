...
public class acc {
   private static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> rq.a("commands.attribute.failed.entity", $$0));
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> rq.a("commands.attribute.failed.no_attribute", $$0, $$1)
   );
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> rq.a("commands.attribute.failed.no_modifier", $$1, $$0, $$2)
   );
   private static final Dynamic3CommandExceptionType d = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> rq.a("commands.attribute.failed.modifier_already_present", $$2, $$1, $$0)
   );
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("attribute").requires($$0x -> $$0x.c(2)))
            .then(
               ds.a("target", eb.a())
                  .then(
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ds.a("attribute", ep.a(hm.w))
                              .then(
                                 ((LiteralArgumentBuilder)ds.a("get")
                                       .executes($$0x -> a((dr)$$0x.getSource(), eb.a($$0x, "target"), ep.a($$0x, "attribute"), 1.0)))
                                    .then(
                           ...
                           .then(
                              ((LiteralArgumentBuilder)ds.a("base")
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)ds.a("get")
                                          .executes($$0x -> b((dr)$$0x.getSource(), eb.a($$0x, "target"), ep.a($$0x, "attribute"), 1.0)))
                                       .then(
                                          ds.a("scale", DoubleArgumentType.doubleArg())
                                             .executes(
                                                $$0x -> b(
                           ...
                           ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("modifier")
                                 ...
                                 .then(
                                    ds.a("remove")
                                       .then(
                                          ds.a("uuid", fb.a())
                                             .executes($$0x -> a((dr)$$0x.getSource(), eb.a($$0x, "target"), ep.a($$0x, "attribute"), fb.a($$0x, "uuid")))
                                       )
                                 ))
                              .then(
                                 ds.a("value")
                                    .then(
                                       ds.a("get")
                                          .then(
                                             ((RequiredArgumentBuilder)ds.a("uuid", fb.a())
                                                   .executes(
                                                      $$0x -> a((dr)$$0x.getSource(), eb.a($$0x, "target"), ep.a($$0x, "attribute"), fb.a($$0x, "uuid"), 1.0)
                                                   ))
                                                .then(
                                                   ds.a("scale", DoubleArgumentType.doubleArg())
                                                      .executes(
