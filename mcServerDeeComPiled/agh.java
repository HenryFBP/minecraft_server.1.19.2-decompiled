...
public class agh extends buc {
   ...
   private int cD = 60;
   private bua cE = bua.a;
   private boolean cF = true;
   private long cG = ad.b();
   @Nullable
   private bbn cH;
   private boolean cI;
   private boolean cJ;
   private final akb cK = new akb();
   @Nullable
   private dwq cL;
   private int cM;
   private boolean cN;
   ...
   @Nullable
   private dwq cQ;
   private hq cR = hq.a(0, 0, 0);
   private aba<cgx> cS = cgx.e;
   @Nullable
   private gt cT;
   private boolean cU;
   private float cV;
   ...
   private final bwz cZ = new bwz() {
      @Override
      public void a(bwm $$0, hi<cax> $$1, cax $$2, int[] $$3) {
         agh.this.b.a(new tx($$0.j, $$0.k(), $$1, $$2));
      ...
      public void a(bwm $$0, int $$1, cax $$2) {
         agh.this.b.a(new tz($$0.j, $$0.k(), $$1, $$2));
      }

      @Override
      public void a(bwm $$0, cax $$1) {
         agh.this.b.a(new tz(-1, $$0.k(), -1, $$1));
      }
      ...
      private void b(bwm $$0, int $$1, int $$2) {
         agh.this.b.a(new ty($$0.j, $$1, $$2));
      }
   };
   private final bwy da = new bwy() {
      @Override
      public void a(bwm $$0, int $$1, cax $$2) {
         byd $$3 = $$0.b($$1);
         if (!($$3 instanceof bxz)) {
   ...
   private void d(agg $$0) {
      ...
      if ($$0.q_().g() && $$0.n().aW().m() != cgu.c) {
         ...
         while(!$$0.g(this) && this.dh() < (double)($$0.ah() - 1)) {
            this.e(this.df(), this.dh() + 1.0, this.dl());
         }
      }
   ...
   public void a(pj $$0) {
      ...
      if ($$0.b("SpawnX", 99) && $$0.b("SpawnY", 99) && $$0.b("SpawnZ", 99)) {
         ...
         if ($$0.e("SpawnDimension")) {
            this.cS = (aba)cgx.d.parse(pu.a, $$0.c("SpawnDimension")).resultOrPartial(co::error).orElse(cgx.e);
         }
      }
   ...
   public void b(pj $$0) {
      ...
      if (this.cP != null) {
         ...
         $$1.a("y", this.cP.d);
         $$1.a("z", this.cP.e);
         $$0.a("enteredNetherPosition", (qc)$$1);
      }
      ...
      if ($$3 != null && $$2 != this && $$2.cN()) {
         ...
         $$4.a("Attach", $$3.co());
         $$4.a("Entity", (qc)$$5);
         $$0.a("RootVehicle", (qc)$$4);
      }

      $$0.a("recipeBook", (qc)this.cK.b());
      ...
      if (this.cT != null) {
         ...
         abb.a.encodeStart(pu.a, this.cS.a()).resultOrPartial(co::error).ifPresent($$1 -> $$0.a("SpawnDimension", $$1));
      }
   ...
   public void l() {
      try {
         ...
         if (this.ef() != this.cz || this.cA != this.bV.a() || this.bV.e() == 0.0F != this.cB) {
            this.b.a(new wn(this.ef(), this.bV.a(), this.bV.e()));
            this.cz = this.ef();
            this.cA = this.bV.a();
         ...
         if (this.cj != this.cC) {
            this.cC = this.cj;
            this.b.a(new wm(this.ck, this.cj, this.ci));
         }
   ...
   public void a(baw $$0) {
      ...
      if ($$1) {
         rq $$2 = this.er().b();
         this.b.a(new vi(this.er(), $$2), rb.a((Supplier<tc<?>>)(() -> {
            int $$1x = 256;
            String $$2 = $$2.a(256);
            rq $$3x = rq.a("death.attack.message_too_long", rq.b($$2).a(p.o));
            rq $$4x = rq.a("death.attack.even_more_magic", this.C_()).a($$1xx -> $$1xx.a(new rv(rv.a.a, $$3x)));
            return new vi(this.er(), $$4x);
         })));
         dxq $$3 = this.bY();
   ...
   private void gb() {
      dwl $$0 = new dwl(this.da()).c(32.0, 10.0, 32.0);
      this.s.a(bce.class, $$0, bbq.f).stream().filter($$0x -> $$0x instanceof bcj).forEach($$0x -> ((bcj)$$0x).a_((buc)this));
   }
   ...
   public bbn b(agg $$0) {
      ...
      if ($$2 == cgx.g && $$0.ab() == cgx.e) {
         ...
         if (!this.f) {
            this.f = true;
            this.b.a(new uj(uj.e, this.cJ ? 0.0F : 1.0F));
            this.cJ = true;
         }
         ...
         drn $$3 = $$0.n_();
         this.b.a(new vq($$0.Z(), $$0.ab(), chv.a($$0.B()), this.d.b(), this.d.c(), $$0.ae(), $$0.A(), true, this.ga()));
         this.b.a(new tr($$3.s(), $$3.t()));
         aiz $$4 = this.c.ac();
         $$4.d(this);
         $$1.a(this, bbn.c.e);
         this.dv();
         ...
         if ($$5 != null) {
            ...
            $$1.ac().c();
            this.e($$1);
            this.b.a(new vd(this.fB()));
            $$4.a(this, $$0);
            $$4.e(this);

            for(bbg $$6 : this.ec()) {
               this.b.a(new xh(this.ae(), $$6));
            }

            this.b.a(new up(1032, gt.b, 0, false));
            this.cC = -1;
            this.cz = -1.0F;
            this.cA = -1;
         }
   ...
   public boolean a(agh $$0) {
      if ($$0.B_()) {
         ...
         return this.B_() ? false : super.a($$0);
      }
   }
      ...
      if (this.fj() || !this.bo()) {
         ...
         if (this.s.M()) {
            ...
            if (!this.f()) {
               ...
               dwq $$4 = dwq.c($$0);
               List<brq> $$5 = this.s
                  .a(brq.class, new dwl($$4.a() - 8.0, $$4.b() - 5.0, $$4.c() - 8.0, $$4.a() + 8.0, $$4.b() + 5.0, $$4.c() + 8.0), $$0x -> $$0x.e(this));
               if (!$$5.isEmpty()) {
            ...
            if (!this.x().d()) {
               this.a(rq.c("sleep.not_possible"), true);
            }
   ...
   private boolean g(gt $$0) {
      dwq $$1 = dwq.c($$0);
      return Math.abs(this.df() - $$1.a()) <= 3.0 && Math.abs(this.dh() - $$1.b()) <= 2.0 && Math.abs(this.dl() - $$1.c()) <= 3.0;
   }
   ...
   public OptionalInt a(@Nullable bam $$0) {
      if ($$0 == null) {
         ...
         if ($$1 == null) {
            if (this.B_()) {
               this.a(rq.c("container.spectatorCantOpen").a(p.m), true);
            }

            return OptionalInt.empty();
         } else {
            this.b.a(new uz($$1.j, $$1.a(), $$0.C_()));
            this.a($$1);
            this.bU = $$1;
   ...
   public void a(bpa $$0, bac $$1) {
      ...
      this.gd();
      this.b.a(new uk(this.db, $$1.b(), $$0.ae()));
   ...
   @Override
   public void a(ctp $$0) {
      this.b.a(tn.a($$0, cti::o));
   }

   @Override
   public void q() {
      this.b.a(new tw(this.bU.j));
      this.r();
   }
   ...
   public void a(akd<?> $$0, int $$1) {
      this.cs.b(this, $$0, $$1);
      this.fQ().a($$0, this.cq(), $$1x -> $$1x.a($$1));
   }

   @Override
   public void a(akd<?> $$0) {
      this.cs.a(this, $$0, 0);
      this.fQ().a($$0, this.cq(), dxn::c);
   }
   ...
   public void a(ea.a $$0, dwq $$1) {
      super.a($$0, $$1);
      this.b.a(new vk($$0, $$1.c, $$1.d, $$1.e));
   }

   public void a(ea.a $$0, bbn $$1, ea.a $$2) {
      dwq $$3 = $$2.a($$1);
      super.a($$0, $$3);
      this.b.a(new vk($$0, $$1, $$2));
   }
   ...
   @Override
   public void a(bbn $$0) {
      this.x().k().a(this, new tj($$0, 4));
   }

   @Override
   public void b(bbn $$0) {
      this.x().k().a(this, new tj($$0, 5));
   }
   ...
   public boolean a(cgu $$0) {
      if (!this.d.a($$0)) {
         ...
         this.b.a(new uj(uj.d, (float)$$0.a()));
         if ($$0 == cgu.d) {
            this.fP();
            this.p();
         } else {
   ...
   public void b(rq $$0, boolean $$1) {
      if (this.u($$1)) {
         this.b.a(new xa($$0, $$1), rb.a((Supplier<tc<?>>)(() -> {
            if (this.u(false)) {
               int $$1x = 256;
               String $$2 = $$0.a(256);
               rq $$3 = rq.b($$2).a(p.o);
   ...
   public String y() {
      ...
      return $$0.substring(0, $$0.indexOf(":"));
   }
   ...
   public void a(String $$0, String $$1, boolean $$2, @Nullable rq $$3) {
      this.b.a(new vp($$0, $$1, $$2, $$3));
   }

   public void a(aae $$0) {
      this.b.a(new vu($$0.a(), $$0.d(), $$0.e(), $$0.f()));
   }
   ...
   public void a(aba<cgx> $$0, @Nullable gt $$1, float $$2, boolean $$3, boolean $$4) {
      if ($$1 != null) {
         ...
         if ($$4 && !$$5) {
            this.a(rq.c("block.minecraft.set_spawn"));
         }
   ...
   public void a(ajv $$0, ajx $$1, float $$2, float $$3) {
      this.b.a(new wy($$0, $$1, this.df(), this.dh(), this.dl(), $$2, $$3, this.R.g()));
   }
   ...
   public boolean a(boolean $$0) {
      bub $$1 = this.fA();
      cax $$2 = $$1.a($$0);
      this.bU.b($$1, $$1.k).ifPresent($$1x -> this.bU.a($$1x, $$1.f()));
