...
public class ab {
   ...
   public static final Level aD = Level.DISABLED;
   public static final boolean aE = false;
   public static final boolean aF = false;
   public static final boolean aG = false;
   public static final boolean aH = false;
   public static final boolean aI = false;
   public static final long aJ = Duration.ofMillis(300L).toNanos();
   public static boolean aK = true;
   public static boolean aL;
   public static anj aM = anj.a;
   ...
   public static final char[] aS = new char[]{'/', '\n', '\r', '\t', '\u0000', '\f', '`', '?', '*', '\\', '<', '>', '|', '"', ':'};
   ...
   public static void d() {
      aM = switch(aM) {
         case c -> throw new IllegalStateException("Tried to enable datafixer optimization after unoptimized initialization");
         case d -> anj.d;
         default -> anj.b;
      };
   }
