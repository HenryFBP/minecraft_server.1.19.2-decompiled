...
public class arj extends DataFix {
   ...
   private static final Set<String> b = (Set<String>)a.keySet().stream().map($$0 -> $$0.substring(0, $$0.indexOf(46))).collect(Collectors.toSet());
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, $$2x -> {
         ...
         if (!$$3.isPresent()) {
            ...
            String $$7 = a((String)((Pair)$$3.get()).getSecond(), $$6);
            if ($$7 != null) {
               $$4 = $$2x.set($$1, Pair.of(asr.s.typeName(), $$7));
            }
   ...
   public static String a(@Nullable String $$0, int $$1) {
      if (b.contains($$0)) {
         String $$2 = (String)a.get($$0 + "." + $$1);
         return $$2 == null ? (String)a.get($$0 + ".0") : $$2;
      } else {
         return null;
      }
   }
