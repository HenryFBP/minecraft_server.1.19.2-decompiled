...
public class ada {
   public static void a(CommandDispatcher<dr> $$0) {
      final LiteralArgumentBuilder<dr> $$1 = (LiteralArgumentBuilder)ds.a("gamerule").requires($$0x -> $$0x.c(2));
      cgt.a(
         new cgt.c() {
            @Override
            public <T extends cgt.g<T>> void a(cgt.e<T> $$0, cgt.f<T> $$1x) {
               $$1.then(
                  ((LiteralArgumentBuilder)ds.a($$0.a()).executes($$1xxx -> ada.a((dr)$$1xxx.getSource(), $$0)))
                     .then($$1.a("value").executes($$1xxx -> ada.a($$1xxx, $$0)))
               );
            }
         }
      );
