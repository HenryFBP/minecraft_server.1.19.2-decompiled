...
public class ahb implements re, zv {
   ...
   public void d() {
      ...
      if ($$3 != null) {
         ...
         if (this.g.av() >= 0 && !this.a.d()) {
            this.a.a(new zt(this.g.av()), rb.a((Runnable)(() -> this.a.a(this.g.av(), true))));
         }
   ...
   public void a(zx $$0) {
      ...
      this.m = (buf.a)$$0.c().orElse(null);
      GameProfile $$1 = this.g.M();
      if ($$1 != null && $$0.b().equalsIgnoreCase($$1.getName())) {
         this.j = $$1;
         this.h = ahb.a.e;
      } else {
         this.j = new GameProfile(null, $$0.b());
         if (this.g.T() && !this.a.d()) {
            this.h = ahb.a.b;
            this.a.a(new zs("", this.g.K().getPublic().getEncoded(), this.f));
         } else {
            this.h = ahb.a.e;
         }
   ...
   public void a(zy $$0) {
      ...
      try {
         ...
         Cipher $$4 = ali.a(2, $$3);
         Cipher $$5 = ali.a(1, $$3);
         $$6 = new BigInteger(ali.a("", this.g.K().getPublic(), $$3)).toString(16);
         this.h = ahb.a.c;
         this.a.a($$4, $$5);
      } catch (alj var7) {
      ...
      Thread $$9 = new Thread("User Authenticator #" + b.incrementAndGet()) {
         public void run() {
            ...
            try {
               ahb.this.j = ahb.this.g.am().hasJoinedServer(new GameProfile(null, $$0.getName()), $$6, this.a());
               if (ahb.this.j != null) {
