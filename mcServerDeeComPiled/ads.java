...
public class ads {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> rq.a("commands.publish.alreadyPublished", $$0));

   public static void a(CommandDispatcher<dr> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("publish").requires($$0x -> $$0x.c(4)))
               .executes($$0x -> a((dr)$$0x.getSource(), ama.a())))
            .then(ds.a("port", IntegerArgumentType.integer(0, 65535)).executes($$0x -> a((dr)$$0x.getSource(), IntegerArgumentType.getInteger($$0x, "port"))))
      );
   }
