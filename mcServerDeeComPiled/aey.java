...
public class aey {
   ...
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(rq.a("commands.worldborder.set.failed.big", 5.9999968E7));
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(rq.a("commands.worldborder.set.failed.far", 2.9999984E7));
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a(
                           ...
                           .then(
                              ds.a("add")
                                 .then(
                                    ((RequiredArgumentBuilder)ds.a("distance", DoubleArgumentType.doubleArg(-5.9999968E7, 5.9999968E7))
                                          .executes(
                                             $$0x -> a(
                                                   (dr)$$0x.getSource(),
                                                   ((dr)$$0x.getSource()).f().p_().i() + DoubleArgumentType.getDouble($$0x, "distance"),
                                                   0L
                                                )
                                          ))
                                       .then(
                                          ds.a("time", IntegerArgumentType.integer(0))
                                             .executes(
                                                $$0x -> a(
                                                      (dr)$$0x.getSource(),
                                                      ((dr)$$0x.getSource()).f().p_().i() + DoubleArgumentType.getDouble($$0x, "distance"),
                                                      ((dr)$$0x.getSource()).f().p_().j() + (long)IntegerArgumentType.getInteger($$0x, "time") * 1000L
                                                   )
                                             )
                                       )
                                 )
                     ...
                     .then(ds.a("center").then(ds.a("pos", fn.a()).executes($$0x -> a((dr)$$0x.getSource(), fn.a($$0x, "pos"))))))
                  .then(
               ...
               ((LiteralArgumentBuilder)ds.a("warning")
                  ...
                  .then(
                     ds.a("time")
                        .then(
                           ds.a("time", IntegerArgumentType.integer(0))
                              .executes($$0x -> a((dr)$$0x.getSource(), IntegerArgumentType.getInteger($$0x, "time")))
                        )
                  )
            )
      );
