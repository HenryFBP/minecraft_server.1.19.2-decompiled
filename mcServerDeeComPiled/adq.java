...
public class adq {
   ...
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> rq.a("commands.place.template.invalid", $$0));
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("place")
                     ...
                     .then(
                        ds.a("feature")
                           .then(
                              ((RequiredArgumentBuilder)ds.a("feature", ep.a(hm.aL))
                                    .executes($$0x -> a((dr)$$0x.getSource(), ep.b($$0x, "feature"), new gt(((dr)$$0x.getSource()).e()))))
                                 .then(ds.a("pos", fh.a()).executes($$0x -> a((dr)$$0x.getSource(), ep.b($$0x, "feature"), fh.a($$0x, "pos"))))
                           )
                     ))
                  .then(
                     ds.a("jigsaw")
                        .then(
                           ds.a("pool", ep.a(hm.aQ))
                              .then(
                                 ds.a("target", eq.a())
                                    .then(
               ...
               .then(
                  ds.a("structure")
                     .then(
                        ((RequiredArgumentBuilder)ds.a("structure", ep.a(hm.aN))
                              .executes($$0x -> b((dr)$$0x.getSource(), ep.c($$0x, "structure"), new gt(((dr)$$0x.getSource()).e()))))
                           .then(ds.a("pos", fh.a()).executes($$0x -> b((dr)$$0x.getSource(), ep.c($$0x, "structure"), fh.a($$0x, "pos"))))
                     )
               ))
            .then(
               ds.a("template")
                  .then(
                     ((RequiredArgumentBuilder)ds.a("template", eq.a())
                           .suggests(f)
                           .executes($$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), new gt(((dr)$$0x.getSource()).e()), cpw.a, coh.a, 1.0F, 0)))
                        .then(
                           ((RequiredArgumentBuilder)ds.a("pos", fh.a())
                                 .executes($$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), fh.a($$0x, "pos"), cpw.a, coh.a, 1.0F, 0)))
                              .then(
                                 ((RequiredArgumentBuilder)ds.a("rotation", ez.a())
                                       .executes(
                                          $$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), fh.a($$0x, "pos"), ez.a($$0x, "rotation"), coh.a, 1.0F, 0)
                                       ))
                                    .then(
                                       ((RequiredArgumentBuilder)ds.a("mirror", ey.a())
                                             .executes(
                                                $$0x -> a(
                                                      (dr)$$0x.getSource(),
                                                      eq.e($$0x, "template"),
   ...
   public static int a(dr $$0, hc<ddg<?, ?>> $$1, gt $$2) throws CommandSyntaxException {
      ...
      if (!$$4.a($$3, $$3.k().g(), $$3.r_(), $$2)) {
         ...
         String $$6 = (String)$$1.e().map($$0x -> $$0x.a().toString()).orElse("[unregistered]");
   ...
   public static int b(dr $$0, hc<dlb> $$1, gt $$2) throws CommandSyntaxException {
      ...
      dlb $$4 = $$1.a();
      cxk $$5 = $$3.k().g();
      dlj $$6 = $$4.a($$0.v(), $$5, $$5.d(), $$3.k().h(), $$3.p(), $$3.B(), new cge($$2), 0, $$3, $$0x -> true);
      if (!$$6.b()) {
         throw c.create();
      } else {
         dkt $$7 = $$6.a();
         ...
         a($$3, $$8, $$9);
         cge.a($$8, $$9).forEach($$3x -> $$6.a($$3, $$3.a(), $$5, $$3.r_(), new dkt($$3x.d(), $$3.u_(), $$3x.e(), $$3x.f(), $$3.ah(), $$3x.g()), $$3x));
         String $$10 = (String)$$1.e().map($$0x -> $$0x.a().toString()).orElse("[unregistered]");
   ...
   public static int a(dr $$0, abb $$1, gt $$2, cpw $$3, coh $$4, float $$5, int $$6) throws CommandSyntaxException {
      ...
      if ($$9.isEmpty()) {
         ...
         if ($$5 < 1.0F) {
            $$13.b().a(new dny($$5)).a(cuo.b((long)$$6));
         }
   ...
   private static void a(agg $$0, cge $$1, cge $$2) throws CommandSyntaxException {
      if (cge.a($$1, $$2).filter($$1x -> !$$0.o($$1x.l())).findAny().isPresent()) {
         throw fh.a.create();
      }
   }
}
