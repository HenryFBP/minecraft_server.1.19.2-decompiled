...
public class ahf implements AutoCloseable {
      ...
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            ...
            if ($$3.isEmpty()) {
               ...
               int $$4 = alz.a($$1, "ruleId", 1);
               String $$5 = alz.a($$1, "serverId", "");
               String $$6 = alz.a($$1, "roomId", "Java:Chat");
               int $$7 = alz.a($$1, "hashesToDrop", -1);
               int $$8 = alz.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = alz.a($$1, "endpoints", null);
               ...
               return new ahf($$12, $$16, $$13, $$15, $$14, $$15, $$20, $$19, $$8);
            }
   ...
   class d implements ahe {
      ...
      public CompletableFuture<List<agv>> a(List<String> $$0) {
         List<CompletableFuture<agv>> $$1 = (List)$$0.stream()
            .map($$0x -> ahf.this.a(this.c, $$0x, ahf.this.l, this.d))
            .collect(ImmutableList.toImmutableList());
         return ad.c($$1).exceptionally($$0x -> ImmutableList.of());
      }
