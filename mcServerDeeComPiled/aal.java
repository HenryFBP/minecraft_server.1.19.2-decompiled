...
public class aal {
   ...
   public static final aak<Byte> a = aak.a(($$0, $$1) -> $$0.writeByte($$1), qx::readByte);
   ...
   public static final aak<btq> r = new aak.a<btq>() {
      ...
      public btq b(qx $$0) {
         return new btq($$0.a(hm.ao), $$0.a(hm.ap), $$0.k());
      }
   };
   ...
   public static final aak<bni> u = aak.a(hm.bK);
   public static final aak<bnp> v = aak.a(hm.bM);
   public static final aak<hc<bqr>> w = aak.a(hm.ac.s());
