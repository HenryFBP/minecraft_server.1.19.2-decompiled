         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ds.a("summon").requires($$0x -> $$0x.c(2)))
            .then(
               ((RequiredArgumentBuilder)ds.a("entity", ec.a())
                     .suggests(gj.d)
                     .executes($$0x -> a((dr)$$0x.getSource(), ec.a($$0x, "entity"), ((dr)$$0x.getSource()).e(), new pj(), true)))
                  .then(
                     ((RequiredArgumentBuilder)ds.a("pos", fo.a())
                           .executes($$0x -> a((dr)$$0x.getSource(), ec.a($$0x, "entity"), fo.a($$0x, "pos"), new pj(), true)))
                        .then(ds.a("nbt", dy.a()).executes($$0x -> a((dr)$$0x.getSource(), ec.a($$0x, "entity"), fo.a($$0x, "pos"), dy.a($$0x, "nbt"), false)))
                  )
            )
      );
   }
      ...
      if (!cgx.k($$5)) {
         ...
         if ($$8 == null) {
            ...
            if ($$4 && $$8 instanceof bce) {
               ((bce)$$8).a($$0.f(), $$0.f().d_($$8.da()), bcg.n, null, null);
            }
