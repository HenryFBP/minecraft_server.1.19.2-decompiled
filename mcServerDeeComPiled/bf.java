...
public class bf {
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      float $$7 = (float)($$1 - $$4);
      float $$8 = (float)($$2 - $$5);
      if (!this.b.d((double)ami.e($$6)) || !this.c.d((double)ami.e($$7)) || !this.d.d((double)ami.e($$8))) {
         return false;
      } else if (!this.e.e((double)($$6 * $$6 + $$8 * $$8))) {
         return false;
      } else {
         return this.f.e((double)($$6 * $$6 + $$7 * $$7 + $$8 * $$8));
      }
   }

   public static bf a(@Nullable JsonElement $$0) {
      if ($$0 != null && !$$0.isJsonNull()) {
         JsonObject $$1 = alz.m($$0, "distance");
